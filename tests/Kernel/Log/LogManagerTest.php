...
namespace EasyTM\Tests\Kernel\Log;
...
//    }
    ...
    public function testDriverCreators()
    {
        ...
        self::assertInstanceOf(Logger::class, $log->createSlackDriver(['url' => 'https://easywechat.com']));
    ...
    public function testCall()
    {
        $app = new ServiceContainer([]);
        $log = new LogManager($app);
        self::assertInternalType('array', $log->getHandlers());
    }
}

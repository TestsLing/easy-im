...
use EasyIM\Kernel\Traits\Observable;
use Exception;
...
class ObservableTest extends TestCase
{
    ...
    public function testCallHandler()
    {
        ...
        $c->push($handler);
        self::assertArrayHasKey('*', $c->getHandlers());
        self::assertInstanceOf(Closure::class, $c->getHandlers()['*'][0]);

        // callable
        $handler = [$this, 'demoHandler'];
        $c->push($handler);
        self::assertSame($handler, $c->getHandlers()['*'][1]);

        // function
        $handler = function () {
        };
        $c->push($handler);
        self::assertSame($handler, $c->getHandlers()['*'][2]);
    }
    ...
    public function testAddObserverWithoutEvent()
    {
        ...
        $handler = \Mockery::mock(EventHandlerInterface::class);
        $c->on('foo', $handler);
        self::assertArrayHasKey('foo', $c->getHandlers());
        self::assertInstanceOf(Closure::class, $c->getHandlers()['foo'][0]);
    ...
    public function testAddObserverWithEventName()
    {
        ...
        self::assertArrayHasKey('foo', $c->getHandlers());
        self::assertInternalType('array', $c->getHandlers()['foo']);
        self::assertCount(1, $c->getHandlers());
        self::assertCount(2, $c->getHandlers()['foo']);
        self::assertInstanceOf(Closure::class, $c->getHandlers()['foo'][0]);
        self::assertInstanceOf(Closure::class, $c->getHandlers()['foo'][1]);
    }
    ...
    public function testAddObserverWithEventNames()
    {
        ...
        self::assertArrayHasKey('foo' | 'bar', $c->getHandlers());
        self::assertInternalType('array', $c->getHandlers()['foo' | 'bar']);
        self::assertCount(1, $c->getHandlers());
        self::assertCount(2, $c->getHandlers()['foo' | 'bar']);
        self::assertInstanceOf(Closure::class, $c->getHandlers()['foo' | 'bar'][0]);
        self::assertInstanceOf(Closure::class, $c->getHandlers()['foo' | 'bar'][1]);
    }
    ...
    public function testUnshift()
    {
        ...
        self::assertCount(1, $c->getHandlers()['foo']);
        ...
        self::assertCount(1, $c->getHandlers()['bar']);
        self::assertSame('handled', $c->getHandlers()['bar'][0](['foo' => 'bar']));
    }
    ...
    public function testNotify()
    {
        ...
        $c->push($handler2);
        $c->push($handler3);
        self::assertSame('mock-response-2', $c->notify('foo', ['foo' => 'bar']));
    }
    ...
    public function testNotifyWithArrayCallableHandler()
    {
        ...
        self::assertSame('handler1', $c->notify('foo', ['name' => 'h1']));
        self::assertSame('handler2', $c->notify('foo', ['name' => 'h2']));
        self::assertSame('handler3', $c->notify('foo', ['name' => 'h3']));
        self::assertSame('handler4', $c->notify('foo', ['name' => 'not-exists']));
    }
    ...
    public function testNotifyWithStopPropagation()
    {
        ...
        $c->push($handler3);
        self::assertNull($c->dispatch('foo', ['foo' => 'bar']));
    }
    ...
    public function testNotifyWithBitOperation()
    {
        ...
        self::assertSame('handler1-response', $c->notify('not-exists', ['foo' => 'bar']));
        self::assertSame('handler1-response', $c->notify('event', ['foo' => 'bar']));
        self::assertSame('handler4-response', $c->notify('image', ['foo' => 'bar']));
        self::assertSame('handler4-response', $c->notify('text', ['foo' => 'bar']));
        self::assertSame('handler3-response', $c->notify('card', ['foo' => 'bar']));
    }
    ...
    public function testNotifyWithHandlerExceptionThrown()
    {
        ...
        $c->push($handler2);
        $c->push($handler3);
        self::assertSame('mock-response-3', $c->notify('foo', ['foo' => 'bar']));
    }
    ...
    public function testTerminateResultHandler()
    {
        ...
        $c->push($handler2);
        $c->push($handler3);
        self::assertSame('mock-terminate-response', $c->notify('foo', ['foo' => 'bar']));
    }
    ...
    public function testFinallyResultHandler()
    {
        ...
        $c->push($handler2);
        $c->push($handler3);
        self::assertSame('mock-finally-response', $c->notify('foo', ['foo' => 'bar']));
    }
    ...
    public function testMakeClosure()
    {
        ...
        $c->push($handler, 'foo');
        self::assertSame('class instance handle', $c->getHandlers()['foo'][0](['foo' => 'bar']));
    }
    ...
    public function testMakeClosureWithInvalidCases()
    {
        try {
            ...
            self::assertSame('Class "foo" not exists.', $e->getMessage());
        }
        ...
        try {
            ...
            self::assertSame('No valid handler is found in arguments.', $e->getMessage());
        }
    }
    ...
    public function testWhereClause()
    {
        ...
        self::assertSame('handler5-response', $c4->notify('e', ['Type' => 'bar', 'User' => 'bar-user']));
    }
}
